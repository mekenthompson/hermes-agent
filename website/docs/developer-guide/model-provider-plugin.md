...
| `external_process` | Auth handled by a subprocess the agent spawns | ACP agent plugins — `copilot-acp` in core; `claude-acp`, `codex-acp`, and community agents via [hermes-acp-agents](https://github.com/mvdbastos/hermes-acp-agents) |
